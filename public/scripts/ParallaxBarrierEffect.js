...
THREE.ParallaxBarrierEffect = function ( renderer ) {
  ...
  this.render = function ( scene, camera, focalUpdated ) {

    scene.updateMatrixWorld();
    this.focalLength = focalUpdated
    ...
    if ( hasCameraChanged ) {
      ...
      var eyeSep = this.focalLength / 30 * 0.5;
      var eyeSepOnProjection = eyeSep * _near / this.focalLength;
